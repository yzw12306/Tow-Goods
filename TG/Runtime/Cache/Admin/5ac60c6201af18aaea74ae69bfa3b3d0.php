 ...
 <body>
 	...
 	<table class="table table-hover table-striped">
 		...
 		<?php if(is_array($list)): foreach($list as $key=>$val): ?><tr>
 				...
 				<td>
 					<a href="<?php echo U('Admin/Admins/saveStatus',['id' => $val['id'] , 'status' => '1' ]);?>" class="btn btn-danger btn-xs statuschange" <?php echo ($val['status']=='1'?'disabled':''); ?> role="button">启用</a>
					<a href="<?php echo U('Admin/Admins/saveStatus',['id' => $val['id'] , 'status' => '2' ]);?>" class="btn btn-danger btn-xs statuschange" <?php echo ($val['status']=='2'?'disabled':''); ?> role="button">失效</a>
 				</td>
